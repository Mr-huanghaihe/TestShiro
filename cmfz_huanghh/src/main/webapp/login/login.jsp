    ...
    <script>
        $(function(){
            ...
            $("#captchaImage").click(function(){
                $("#captchaImage").prop('src',"${path}/admin/code?"+new Date().getTime());
            });
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${path}/shiro/login" method="post" class="login-form" id="loginForm">
                            <span id="msgDiv"></span>
                            ...
                            <div class="form-group">
                                ...
                                <input  minlength="4" style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="text" name="code" id="form-code">
                            </div>
