...
public class PhoneMessageUtil {
    ...
    public static SendSmsResponse getMsg(String phoneNumbers,String signName,String templateCode,String templateParam ) throws Exception{
        ...
        //替换成你的AK
        final String accessKeyId = "LTAIn5vCyF0978IO";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "EIW8kjXIub5JPNiqlm3Mu7GM3PkX6c";//你的accessKeySecret，参考本文档步骤2
    ...
    public static String getPhoneMsg(String phone,String randomCode){
        ...
        String message=null;
        try {
            SendSmsResponse messages = getMsg(phone, "小蛋黄", "SMS_172008044", "{\"code\":\""+randomCode+"\"}");
    ...
    /*public static void main(String[] args) {
        String message = getPhoneMsg("phoneNumbers");
